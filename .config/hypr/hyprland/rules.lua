...
-- Fuzzel (layer-shell namespace "launcher"): frosted card, pop-in, dim stage
hl.layer_rule({ match = { namespace = "launcher" }, animation = "popin 88%"})
hl.layer_rule({ match = { namespace = "launcher" }, blur = true})
hl.layer_rule({ match = { namespace = "launcher" }, ignore_alpha = 0.25})
